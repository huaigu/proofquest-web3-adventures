-- ProofQuest Database Setup Script
-- This file contains all SQL commands to set up the database and insert mock data
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_type WHERE typname = 'distribution_method_enum') THEN
...
ALTER TABLE quests 
ADD CONSTRAINT IF NOT EXISTS fk_quest_creator 
...
(
    '0x8ba1f109551bd432803012645hac136c5532c21c',
    'Bob Smith', 
